          ...
          <div className="flex items-center gap-8">
            {navigation.company.map((item, i) => (
              <a
                key={`${item.name}-${i}`}
                href={item.href}
                className="font-medium text-white hover:text-gray-200 transition-colors ease-in-out delay-75"
              >
                {item.name}
              </a>
            ))}
          ...
          <div className="flex space-x-6">
            {navigation.social.map((item, i) => (
              <a
                key={`${item.name}-${i}`}
                href={item.href}
                className="text-gray-500 hover:text-nintendoRed-600 transition-colors ease-in delay-75 duration-200"
              >
